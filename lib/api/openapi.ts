...
export async function openAiRequest(
  ...
  const prompt = `너는 첨부한 사진과 사용자가 먹었다고 하는 음식 문구를 기준으로 칼로리를 예측하는 영양사야. 
                        ...
                        예시: { 
                                  "ai_text": "밥 (약 1/2 공기)약 150 kcal 떡볶이 (약 1/3 인분) 약 200 kcal 김말이 (3개) 약 150 kcal (각 50 kcal) 쥐포 (약 1/3 인분) 약 50 kcal 깻잎무침 (1개) 약 20 kcal 양념만두 (3개) 약 180 kcal (각 60 kcal) 미니돈가스 (2개) 약 140 kcal (각 70 kcal) 총 칼로리: 150 + 200 + 150 + 50 + 20 + 180 + 140 = 890 kcal 따라서, 사용자가 먹은 음식의 총 칼로리는 약 890 kcal로 추정됩니다.",
